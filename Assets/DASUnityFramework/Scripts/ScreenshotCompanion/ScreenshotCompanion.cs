...
using System.IO;
using DASUnityFramework.Scripts.ScreenshotCompanion.Framework;
using UnityEngine;

// ScreenshotCompanion
namespace DASUnityFramework.Scripts.ScreenshotCompanion
{
    [ExecuteInEditMode]
    public class ScreenshotCompanion : MonoBehaviour
    {
        ...
        public string getSaveDirectory()
        {
            ...
            if (settings.customDirectoryName != "")
                directory = settings.customDirectoryName;
		...
		*/
        ...
        public void CaptureScreenshots(int id, bool fallback)
        {
            ...
            string directoryName = checkSaveDirectory();
            string fileName = Path.Combine(directoryName, getFileName(id));
        ...
        public string getFileName(int camID)
        {
            ...
            {
                return settings.customFileName + ".png";
